...
<section class="h-screen w-screen bg-black flex flex-col">
	...
	<div class="pl-5 mt-auto pb-28 md:pb-8">
		<div class="md:h-32 h-12 text-5xl md:text-9xl font-bold text-white mt-auto">
			10x performance is
		</div>

		<div
			id="messenger"
			class="md:h-36 h-14 text-5xl md:text-9xl font-bold text-white mt-auto overflow-hidden"
		>
			loading...
		</div>
	</div>
